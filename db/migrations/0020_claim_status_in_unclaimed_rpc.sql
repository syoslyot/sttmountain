-- Updates list_unclaimed_expeditions to include a claim_status field.
-- 'pending'   → has at least one pending leader claim; card shown but disabled on frontend
-- 'unclaimed' → no pending or approved leader claim; card shown and claimable
...
values ('0020_claim_status_in_unclaimed_rpc')
